...
<a href="<?php echo Yii::app()->createUrl('catalogue/view/',array( 'id'=>$cata->id)); ?> ">
	<h4 class="name inbl pl1">Éditions <?php echo ucfirst($cata->name) ?></h4>
	<a  class="ml2 inbl icon icon-bracket2 after" href="<?php echo Yii::app()->createUrl('catalogue/view/',array( 'id'=>$cata->id)); ?> ">Découvrir le catalogue de l'éditeur</a>
